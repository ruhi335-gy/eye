...
cat << EOF
    ...
    ${cyan}[${orange}6${cyan}]${white} Ludo Game
    ${cyan}[${orange}7${cyan}]${white} Fake Game Loader
    ${cyan}[${orange}8${cyan}]${red} Exit${nocolor}

    ${blue}══════════════════════════════════════${nocolor}
    ${cyan}[${orange}11${cyan}]${white} Change Image Path
    ${white} Current: ${green}$CAPTURE_PATH${nocolor}
    ${blue}══════════════════════════════════════${nocolor}
